...
```sh
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/NSS-Day-Cohort-71/client-side-mastery/master/book-1-installations/chapters/scripts/installs-wsl.sh)"
```
